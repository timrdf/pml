The Provenance Markup Language (PML 3.0) is an OWL ontology that extends W3C's [PROV-O](http://www.w3.org/TR/prov-o/) with the best parts of [PML 2.0](http://inference-web.org/wiki/Documentation).
